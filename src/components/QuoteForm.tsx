...
export const QuoteForm = () => {
  ...
  const locations = [
    { name: "NAIROBI", address: "Industrial Area, Nairobi", phone: "+254 782 673 237" },
    { name: "MOMBASA", address: "Changamwe, Mombasa", phone: "+254 782 673 237" },
    { name: "KISUMU", address: "Kisumu Town, Nyanza", phone: "+254 782 673 237" },
  ];
